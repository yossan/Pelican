//
//  MessageAttribute+parseBody.swift
//  Pelican iOS
//
...
extension MessageAttribute {
    static func parseBody(mailimap_body body: UnsafeMutablePointer<mailimap_body>) -> MailPart {
        /*
         int bd_type;
         ...
         */
        let mailPart: MailPart
        switch Int(body.pointee.bd_type) {
        case MAILIMAP_BODY_MPART:
            let mpart = body.pointee.bd_data.bd_body_mpart!
            mailPart = parse(mailimap_body_type_mpart: mpart, partId: nil)
        case MAILIMAP_BODY_1PART:
            mailPart = parse(mailimap_body_type_1part: body.pointee.bd_data.bd_body_1part, partId: "1")
        default:
            fatalError()
        }
        return mailPart
    ...
    static private func parse(mailimap_body_type_msg msg: UnsafeMutablePointer<mailimap_body_type_msg>, partId: String) -> MailPart {
        ...
        let mailPart   = self.parseBody(mailimap_body: msg.pointee.bd_body!)
